 ...
 */
@JsonPropertyOrder({
    SharkDto.JSON_PROPERTY_PEOPLE_BITTEN,
    SharkDto.JSON_PROPERTY_FRIENDLY
})
...
public class SharkDto extends AnimalDto {
    ...
    public SharkDto peopleBitten(@jakarta.annotation.Nullable BigDecimal peopleBitten) {
    ...
    public SharkDto friendly(@jakarta.annotation.Nullable Boolean friendly) {
