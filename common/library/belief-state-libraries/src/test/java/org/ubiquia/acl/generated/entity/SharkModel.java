 ...
 */
@JsonPropertyOrder({
    SharkModel.JSON_PROPERTY_PEOPLE_BITTEN,
    SharkModel.JSON_PROPERTY_FRIENDLY
})
...
@Entity
public class SharkModel extends AnimalModel {
    ...
    public SharkModel peopleBitten(@jakarta.annotation.Nullable BigDecimal peopleBitten) {
    ...
    public SharkModel friendly(@jakarta.annotation.Nullable Boolean friendly) {
    ...
    public boolean equals(Object o) {
        ...
        SharkModel sharkEntity = (SharkModel) o;
