 ...
 */
@JsonPropertyOrder({
    PersonModel.JSON_PROPERTY_HAIR_COLOR,
    PersonModel.JSON_PROPERTY_NAME,
    PersonModel.JSON_PROPERTY_PETS
})
...
@Entity
public class PersonModel extends BaseModelModel {
    ...
    private NameModel nameEntity;
    @jakarta.annotation.Nullable


    @OneToMany(mappedBy = "owner", cascade = CascadeType.ALL)

    private List<@Valid AnimalModel> pets = new ArrayList<>();

    public PersonModel() {

    }

    public PersonModel hairColor(@jakarta.annotation.Nullable ColorType hairColor) {
    ...
    public PersonModel name(@jakarta.annotation.Nullable NameModel nameEntity) {
    ...
    public PersonModel pets(@jakarta.annotation.Nullable List<@Valid AnimalModel> pets) {

        this.pets = pets;
        return this;
    }

    public PersonModel addPetsItem(AnimalModel petsItem) {
        if (this.pets == null) {
    ...
    public List<@Valid AnimalModel> getPets() {
        return pets;
    }
    ...
    @JsonProperty(JSON_PROPERTY_PETS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPets(@jakarta.annotation.Nullable List<@Valid AnimalModel> pets) {
        this.pets = pets;
    }
    ...
    public boolean equals(Object o) {
        ...
        PersonModel personEntity = (PersonModel) o;
