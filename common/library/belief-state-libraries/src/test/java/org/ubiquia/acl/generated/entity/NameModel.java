 ...
 */
@JsonPropertyOrder({
    NameModel.JSON_PROPERTY_FIRST_NAME,
    NameModel.JSON_PROPERTY_LAST_NAME
})
...
@Entity
public class NameModel extends AbstractAclModel {
    ...
    public NameModel firstName(@jakarta.annotation.Nonnull String firstName) {
    ...
    public NameModel lastName(@jakarta.annotation.Nullable String lastName) {
    ...
    public boolean equals(Object o) {
        ...
        NameModel nameEntity = (NameModel) o;
