 ...
 */
@JsonPropertyOrder({
    DogEntity.JSON_PROPERTY_BARK_DECIBELS
})
...
public class DogEntity extends AnimalEntity {
    ...
    /** Sets barkDecibels and returns this instance. */
    public DogEntity barkDecibels(@jakarta.annotation.Nullable Float barkDecibels) {
