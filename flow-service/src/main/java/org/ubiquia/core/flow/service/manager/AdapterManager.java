...
import org.ubiquia.core.flow.service.logic.adapter.CommonAdapterBusinessLogic;
...
public class AdapterManager {
    ...
    @Autowired
    private CommonAdapterBusinessLogic commonAdapterBusinessLogic;
    @Autowired
    ...
    public void tryDeployAdaptersFor(final GraphDeployment graphDeployment) throws Exception {
        ...
        this.tryDeployDataTransformlessAdaptersFor(graphEntity, graphDeployment);
    ...
    public void teardownAllAdapters() {
        ...
        for (var graphName : this.adapterMap.keySet()) {
            for (var adapterId : this.adapterMap.get(graphName).keySet()) {
                ...
                this.commonAdapterBusinessLogic.tearDown(adapter);
            }
        }
     ...
     */
    private void tryDeployDataTransformlessAdaptersFor(
        final Graph graphEntity,
        final GraphDeployment graphDeployment)
        throws Exception {
