...
/**
 * A controller that exposes simulation capabilities for the belief state generator service.
 * Only active when the deployment mode is not PROD.
 */
@RestController
@RequestMapping("/ubiquia/core/belief-state-generator-service/simulation")
