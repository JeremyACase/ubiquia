...
public class DummyFactory {
    ...
    public Node generateNode() {
        var adapter = Instancio
            ...
            .ignore(field(Node::getParentGraph))
            .ignore(field(Node::getBrokerSettings))
            .ignore(field(Node::getTargetComponent))
            .ignore(field(Node::getTargetGraph))
    ...
    /** Generates a DomainOntology for testing. */
    ...
    /** Generates a DomainDataContract for testing. */
