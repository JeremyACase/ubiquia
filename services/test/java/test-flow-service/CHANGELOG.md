...
## [0.39.0] - 2026-06-25
### Added
- `CrossGraphDataFlowTestModule`: integration test module that validates cross-graph message routing via `targetGraph`; registered in `TestManager` and run as part of the end-to-end test suite
